...
export default function EventQuickNav() {
  ...
  return (
    <div className="fixed bottom-5 left-4 z-[190] sm:bottom-6 sm:left-6">
      {open && (
      ...
      <button type="button" onClick={() => setOpen((current) => !current)} aria-expanded={open} aria-label="Open 18 events navigation" className="flex items-center gap-2 rounded-full border border-gold/35 bg-[#120909]/90 px-4 py-3 font-poppins text-[10px] uppercase tracking-[1.5px] text-gold-soft shadow-[0_12px_35px_rgba(0,0,0,.45)] backdrop-blur-xl transition hover:border-gold/60 hover:bg-[#241016]">
